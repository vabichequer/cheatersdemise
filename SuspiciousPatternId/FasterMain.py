...
if __name__ == '__main__':
    ...
    def main():
        ...
        dump_exists = os.path.isfile(str(tol) + '/' + str(tol) + '-times_correct.csv')
        dump_exists = os.path.isfile(str(tol) + '/' + str(tol) + '-times_wrong.csv')
        dump_exists = os.path.isfile(str(tol) + '/' + str(tol) + '-correct_count.csv')
        dump_exists = os.path.isfile(str(tol) + '/' + str(tol) + '-wrong_count.csv')
        ...
        if (dump_exists):
            ...
            correctExercises_minutes = np.loadtxt(str(tol) + '/' + str(tol) + '-times_correct.csv')
            wrongExercises_minutes = np.loadtxt(str(tol) + '/' + str(tol) + '-times_wrong.csv')

            correctExercisesCount = np.loadtxt(str(tol) + '/' + str(tol) + '-correct_count.csv')
            wrongExercisesCount = np.loadtxt(str(tol) + '/' + str(tol) + '-wrong_count.csv')
            
            N_USERS = len(wrongExercisesCount)
            ...
            np.savetxt(str(tol) + '/' + str(tol) + '-times_correct.csv', correctExercises_minutes, delimiter=",")
            np.savetxt(str(tol) + '/' + str(tol) + '-times_wrong.csv', wrongExercises_minutes, delimiter=",")
                    
            np.savetxt(str(tol) + '/' + str(tol) + '-correct_count.csv', correctExercisesCount, delimiter=",")
            np.savetxt(str(tol) + '/' + str(tol) + '-wrong_count.csv', wrongExercisesCount, delimiter=",")
        ...
        plt.savefig(str(tol) + '/' + str(trimming) + '-connection-graph-' + FLAG + '.svg', format='svg', dpi=1200)
